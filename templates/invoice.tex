...
{% else %}
\setupTABLE[c][5][width=30mm,align={nothyphenated,flushright,lohi}]   % vat
\setupTABLE[c][6][width=25mm,align={nothyphenated,flushright,lohi}]   % vat
\setupTABLE[c][7][width=30mm,align={nothyphenated,flushright,lohi}]   % brutto
\setupTABLE[c][8][width=25mm,align={nothyphenated,flushright,lohi}]   % brutto
{% endif %}
...
\bTR
    ...
    \bTD[nr=2] {{ line.product_name }}\eTD
